...
Licensing -
This utility is free to use, recreate etc. for non-commercial purpose only. 
 
_This utility is create with the help of XMLPrime library. The free usage of this library is limited to non-commercial purposes. please refer to the [licensing terms](https://www.xmlprime.com/xmlprime/licensing.htm) for more information._